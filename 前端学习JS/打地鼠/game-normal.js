window.onload = function () {
    ...
    let cursorPic=document.getElementById('cursorPic');
    ...
    document.onmousemove=function(e){
        ...
        cursorPic.style.left=e.clientX+scrollLeft-cursorPic.width/2+"px";
        cursorPic.style.top=e.clientY+scrollTop-cursorPic.height/2+"px";

    }

    document.addEventListener('click',function(){
        cursorPic.style.animation="rotate 0.1s";
        setTimeout(function(){
            cursorPic.style.animation="";
        },100)
    });
